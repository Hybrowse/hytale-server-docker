...
HYTALE_SESSION_TOKEN_BROKER_ENABLED="${HYTALE_SESSION_TOKEN_BROKER_ENABLED:-false}"
HYTALE_SESSION_TOKEN_BROKER_URL="${HYTALE_SESSION_TOKEN_BROKER_URL:-}"
HYTALE_SESSION_TOKEN_BROKER_BEARER_TOKEN="${HYTALE_SESSION_TOKEN_BROKER_BEARER_TOKEN:-}"
HYTALE_SESSION_TOKEN_BROKER_BEARER_TOKEN_SRC="${HYTALE_SESSION_TOKEN_BROKER_BEARER_TOKEN_SRC:-}"
HYTALE_SESSION_TOKEN_BROKER_ACCOUNT="${HYTALE_SESSION_TOKEN_BROKER_ACCOUNT:-}"
HYTALE_SESSION_TOKEN_BROKER_PROFILE_UUIDS="${HYTALE_SESSION_TOKEN_BROKER_PROFILE_UUIDS:-}"
HYTALE_SESSION_TOKEN_BROKER_TIMEOUT_SECONDS="${HYTALE_SESSION_TOKEN_BROKER_TIMEOUT_SECONDS:-10}"
HYTALE_SESSION_TOKEN_BROKER_FAIL_ON_ERROR="${HYTALE_SESSION_TOKEN_BROKER_FAIL_ON_ERROR:-true}"
HYTALE_SESSION_TOKEN_BROKER_MIN_RETRY_INTERVAL_SECONDS="${HYTALE_SESSION_TOKEN_BROKER_MIN_RETRY_INTERVAL_SECONDS:-}"
...
if is_true "${HYTALE_SESSION_TOKEN_BROKER_ENABLED}"; then
  token_broker_script="/usr/local/bin/hytale-session-token-broker"
  if [ -f "${token_broker_script}" ]; then
    . "${token_broker_script}"
  elif [ -f "$(dirname "$0")/session-token-broker.sh" ]; then
    . "$(dirname "$0")/session-token-broker.sh"
  else
    log "ERROR: Token broker script not found: ${token_broker_script}"
    exit 1
  fi
